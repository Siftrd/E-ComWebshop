<%-- 
    Document   : Cart
    Created on : April 27, 2022, 12:57:20 PM
    Author     : rioxv
--%>
                                            ...
                                            <c:forEach items="${sessionScope.cartList}" var="o">
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="addSubQuantity?action=sub&id=${o.id}"><button class="btnSub">-</button></a> 
                                                        <strong>${o.quantity}</strong>
                                                        <a href="addSubQuantity?action=add&id=${o.id}"><button class="btnAdd">+</button></a>
                                                    </td>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">VAT</strong><strong>${total/10} $</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng thanh toán</strong>
                                            <h5 class="font-weight-bold">${total+(total/10)} $</h5>
                                        </li>
